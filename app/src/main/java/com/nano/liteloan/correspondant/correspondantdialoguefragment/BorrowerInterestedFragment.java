...
public class BorrowerInterestedFragment extends DialogFragment {

    private MainActivity context;

    public BorrowerInterestedFragment(MainActivity context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_borrower_interested, container, false);
        ...
        btnCon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                BorrowerInterestedFragment.this.dismiss();
