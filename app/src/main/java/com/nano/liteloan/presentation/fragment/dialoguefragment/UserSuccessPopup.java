...
public class UserSuccessPopup extends DialogFragment {

    private MainActivity context;
    private OnContinue onContinue;


    public UserSuccessPopup(MainActivity context, OnContinue onContinue) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.user_success_dialog,
                container, false);
