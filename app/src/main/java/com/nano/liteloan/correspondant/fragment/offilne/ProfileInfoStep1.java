...
public class ProfileInfoStep1 extends Fragment implements View.OnClickListener {
    ...
    public ProfileInfoStep1(OfflineProfileMainFrag offlineProfileMainFrag) {
...
//        });
        ...
        ivProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    CropImage.activity()
                            ...
                            .start(context, ProfileInfoStep1.this);
        ...
        if(main.borrowerList!=null && main.borrowerList.cnic != null && !main.borrowerList.cnic.isEmpty()){
            tvName.setText(main.borrowerList.name);
            tvDOB.setText(main.borrowerList.dob);
            if(main.borrowerList.gender == "male"){
                ivMale.performClick();
            } else if(main.borrowerList.gender == "female"){
                ivFemale.performClick();
            } else if(main.borrowerList.gender == "transgender"){
                ivTransgender.performClick();
            }
            setMarital(main.borrowerList.maritalStatus);
            tvParentage.setText(main.borrowerList.parentage);
        }
        return view;
    }
