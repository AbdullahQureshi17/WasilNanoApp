...
public class FeeSucessDialog extends DialogFragment {

    private MainActivity context;


    public FeeSucessDialog(MainActivity context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.success_dialog,
                container, false);
