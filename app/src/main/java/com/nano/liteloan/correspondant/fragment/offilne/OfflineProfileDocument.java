...
public class OfflineProfileDocument extends Fragment implements View.OnClickListener {
    ...
    public OfflineProfileDocument(OfflineProfileMainFrag offlineProfileMainFrag) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_offline_profile_document, container, false);
...
//                scanAction(new BlinkIdUISettings(prepareRecognizerBundle(mRecognizer)));
    ...
    private void dispatchTakePictureIntent() {
        ...
        CropImage.activity()
                ...
                .start(context, OfflineProfileDocument.this);
...
//    }
    ...
    private void createUser() {
        ...
        if ((documents.cnicBack == null && documents.cnicBackURL == null) ||
            ...
            main.userProfile.setCnicBack(documents.cnicBack);
            main.userProfile.setCnicFront(documents.cnicFront);
            main.userProfile.setUtilityBill(documents.utility);
            main.userProfile.setOther(documents.salary);
            submitUserDocuments();
        }
    ...
    private void submitUserDocuments() {

        context.OfflineMobileFrag(main.userProfile , main.borrowerList);
