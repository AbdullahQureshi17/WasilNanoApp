...
public class ProfileSuccessPopup extends DialogFragment {

    private MainActivity context;


    public ProfileSuccessPopup(MainActivity context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.profile_success_dialog,
                container, false);
        ...
        btnCon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ProfileSuccessPopup.this.dismiss();
