...
public class VerificationUpdatedDialgoue extends DialogFragment {

    private TextView tvText;
    private MainActivity context;
    private String value;

    public VerificationUpdatedDialgoue(MainActivity context , String value) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_verification_updated_dialgoue, container, false);
        ...
        btnCon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                VerificationUpdatedDialgoue.this.dismiss();
