...
public class ProfileSuccessNotDocPopup extends DialogFragment {

    private MainActivity context;


    public ProfileSuccessNotDocPopup(MainActivity context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.not_doc_success_dialog,
                container, false);
        ...
        btnCon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ProfileSuccessNotDocPopup.this.dismiss();
