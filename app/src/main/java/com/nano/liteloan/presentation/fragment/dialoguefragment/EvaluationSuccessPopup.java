...
public class EvaluationSuccessPopup extends DialogFragment {

    private MainActivity context;


    public EvaluationSuccessPopup(MainActivity context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.evaluation_success_dialog,
                container, false);
        ...
        btnCon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                EvaluationSuccessPopup.this.dismiss();
